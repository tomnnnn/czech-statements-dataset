...
llm = openai_api.OpenAI_API("Qwen/Qwen2.5-32B-Instruct-GPTQ-Int4")
# TODO: prompt config
predictor = BasicPredictor(llm, "system_prompt", "generation_prompt", "prompt_template", ["pravda", "nepravda"])
