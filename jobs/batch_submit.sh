...
TO_REPLACE='$DATA,$PROMPT_PATH,$ALLOWED_LABELS,$MODEL,$BATCH_SIZE,$SAMPLE_PORTION,$MAX_INDEX,$EXAMPLE_COUNT,$EXPLANATION,$DATASET_PATH,$EVIDENCE_SOURCE,$NAME,$MODEL_API'
